                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control cust-control" name="month">
                                                ...
                                                <option <?php if($bulan_ini == "January") echo 'selected' ;?> value="January">January</option>
                                                <option <?php if($bulan_ini == "February") echo 'selected' ;?> value="February">February</option>
                                                <option <?php if($bulan_ini == "March") echo 'selected' ;?> value="March">March</option>
                                                <option <?php if($bulan_ini == "April") echo 'selected' ;?> value="April">April</option>
                                                <option <?php if($bulan_ini == "May") echo 'selected' ;?> value="May">May</option>
                                                <option <?php if($bulan_ini == "June") echo 'selected' ;?> value="June">June</option>
                                                <option <?php if($bulan_ini == "July") echo 'selected' ;?> value="July">July</option>
                                                <option <?php if($bulan_ini == "August") echo 'selected' ;?> value="August">August</option>
                                                <option <?php if($bulan_ini == "September") echo 'selected' ;?> value="September">September</option>
                                                <option <?php if($bulan_ini == "October") echo 'selected' ;?> value="October">October</option>
                                                <option <?php if($bulan_ini == "November") echo 'selected' ;?> value="November">November</option>
                                                <option <?php if($bulan_ini == "Desember") echo 'selected' ;?> value="Desember">December</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
