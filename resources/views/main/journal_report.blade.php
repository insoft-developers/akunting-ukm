                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color:whitesmoke;"><strong>{{ $key->transaction_name }}</strong></td>
                                                    <td style="background-color:whitesmoke;"></td>
                                                    <td style="background-color:whitesmoke;"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="border-top:2px solid black;">{{ number_format($total_debet) }}</th>
                                                    <th style="border-top:2px solid black;">{{ number_format($total_credit) }}</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
